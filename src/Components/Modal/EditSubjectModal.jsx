              ...
              <div className="flex w-full space-x-4">
                ...
                <div className="h-full w-full space-y-0.5">
                  ...
                  <textarea
                    ...
                    className="h-36 w-full resize-none appearance-none border-2 border-slate-200 bg-gray-50 px-2.5 py-1.5 text-justify font-body transition-colors focus:border-yellow-400 focus:bg-white focus:outline-none"
                  />
                </div>
              </div>
            </div>
