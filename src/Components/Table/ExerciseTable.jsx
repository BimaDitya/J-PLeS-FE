import DeleteExerciseModal from "../Modal/DeleteExerciseModal";
        ...
        <table className="w-full text-slate-400">
          ...
          <tbody>
            <tr className="h-8 border-b bg-white font-body text-slate-600">
              ...
              <td className="px-4 py-2">Syntax Exercise 1</td>
              <td className="px-4 py-2 text-center">Java Syntax</td>
