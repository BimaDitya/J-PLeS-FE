  ...
  return (
    <div className="w-1/2 bg-white shadow px-8 py-4 border-2 border-slate-100 rounded">
      <div className="w-full flex flex-col items-center justify-center">
        <p className="font-head text-xl text-center font-bold py-2">
          Registrasi
        </p>
            ...
            <div className="flex flex-row justify-between items-center">
              <div className="font-body inline-flex text-slate-600">
                ...
                <button
                  ...
                  className="font-head font-bold text-slate-800 hover:text-yellow-400 transition-colors">
                  Masuk
                </button>
              </div>
              <button
                type="submit"
                className="bg-slate-600 rounded text-lg font-semibold px-6 py-2.5 font-head text-white transition">
                Registrasi
              </button>
            </div>
          </form>
